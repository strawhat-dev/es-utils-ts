 ...
 */
export declare const Range: (start?: number, stop?: number, step?: number, _incl?: boolean) => {};
/**
 * Note: A decreasing range (`step = -1`) will be
 * automatically inferred if not specified and `start > stop`
 * or only a single negative `start` value is given.
 ...
 */
export declare const irange: (start?: number, stop?: number, step?: number) => number[];
/**
 * Allows one to semantically check if a given number
 ...
 */
export declare const iRange: (start?: number, stop?: number, step?: number, _incl?: boolean) => {};
