...
declare const isAsyncIterator: (value: unknown) => value is AsyncIterator<unknown, any, undefined>;
declare const isConstructor: (value: unknown) => value is Constructor<unknown>;
